describe('Unit : eCommercePluginDesign design Enums', function () {
  ...
  describe('Enum : TAG_NAMES', function () {
    ...
    it('TAG_NAMES.CONTACT_INFO should exist and equals to "ContactInfo"', function () {
      expect(TAG_NAMES.SHOPIFY_INFO).toEqual('shopifyInfo');
    });
  ...
  describe('Enum : LAYOUTS', function () {
    ...
    it('LAYOUTS.itemListLayout should exist and equals to object', function () {
      expect(typeof LAYOUTS.itemListLayout).toEqual('object');
    });
    it('LAYOUTS.sectionListLayout should exist and equals to object', function () {
      expect(typeof LAYOUTS.sectionListLayout).toEqual('object');
    });
    it('LAYOUTS.itemListLayout should exist and equals array of layouts', function () {
      expect(LAYOUTS.itemListLayout).toEqual(itemListLayout);
    });
    it('LAYOUTS.sectionListLayout should exist and equals array of layouts', function () {
      expect(LAYOUTS.sectionListLayout).toEqual(sectionListLayout);
    });
  });
});
